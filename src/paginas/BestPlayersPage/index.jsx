...
const BestPlayersPage = () => {
    ...
    function mostrarRanks(rank, index){
        ...
        return  <>
                    <tr className={index+1 === 1 ? "bestLapTimeCombination" : index+1 === 2 ? "secondBestLapTimeCombination" : index+1 === 3 ? "thirdBestLapTimeCombination" : "" } key={rank.posicion+index} role="button" tabIndex="0" data-bs-toggle="offcanvas" data-bs-target={`#${offCanvasId}`} aria-controls="offcanvasRight">
                        <td>{rank.posicion}</td>
